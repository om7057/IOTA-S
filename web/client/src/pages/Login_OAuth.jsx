      ...
      <div className="w-full max-w-md">
        <div className="bg-white rounded-2xl shadow-lg p-8 border border-gray-100">
          ...
          <button
            ...
            disabled={isLoading}
            className="w-full border border-gray-300 rounded-lg py-2 px-4 flex items-center justify-center gap-2 hover:bg-gray-50 transition-colors disabled:opacity-50 mb-6"
          >
          ...
          <div className="text-center">
            <p className="text-gray-600 text-sm">
              ...
              <a href="/sign-up" className="text-sky-600 hover:text-sky-700 font-semibold">
                Sign Up
              </a>
            </p>
          </div>
